          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                <li><a href=""><i class="fa fa-home"></i> Alumnos</a>
            ...
            <ul class=" navbar-right">
              <li class="nav-item dropdown open" style="padding-left: 15px;">
                ...
                <div class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
                  ...
                  <a class="dropdown-item" href="./logout.php"><i class="fa fa-sign-out pull-right" style="color:red"></i> Log Out</a>
                </div>
              </li>
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="card-box table-responsive">
                        <p class="text-muted font-13 m-b-30">
                          ...
                          <div class="container">
                          <button class="btn btn-success my-3" data-bs-toggle="modal" data-bs-target="#modalNewDevice">Agregar Alumno</button>
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Ingresar nuevo estudiante</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                        <form action="../config/insertDatos.php" method="POST">
                        <div class="mb-3">
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            $sql = $conexion->query("SELECT * FROM students");
                            ...
                            ?>
                              ...
                              <tr>
                                ...
                                <td>
                                  <a href="" class=" btn btn-warning" data-bs-toggle="modal" data-bs-target="#modalUpdate<?php echo $resultado['id_estudiante']?>" >Editar</a>
                                  <div class="modal fade" id="modalUpdate<?php echo $resultado['id_estudiante']?>"  tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                        <form action="../config/editarDatos.php" method="POST">
                        <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Id</label>
                                <input type="number" class="form-control" name="id_estudiante" readonly value="<?php echo $resultado['id_estudiante']?>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Nombre</label>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-success">Añadir Producto
                                  ...
                                  <a href="../config/eliminarDatos.php?Id=<?php echo $resultado['id_estudiante']?>"  class=" btn btn-danger">Eliminar</a>
                                </td>
                              </tr>
